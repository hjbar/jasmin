...
async function runWasm() {
  // Init args
  const wasmPath = path.join(__dirname, 'prog/chacha20xor-opt_wasm.wasm');
  ...
  for (let i = 0; i < WARMUP_ITER; i++) {
    exports.jade_stream_chacha_chacha20_amd64_ref_xor(outPtr, inPtr, INPUT_LENGTH, noncePtr, keyPtr);
  }
