...
run_benchmark $NB_REPEAT 80000000   "32" "$NONCE" "$KEY"
run_benchmark $NB_REPEAT 38400000  "256" "$NONCE" "$KEY"
run_benchmark $NB_REPEAT  4900000 "2048" "$NONCE" "$KEY"
