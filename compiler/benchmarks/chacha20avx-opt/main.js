...
async function runWasm() {
  // Init args
  const wasmPath = path.join(__dirname, 'prog/chacha20avx-opt_wasm.wasm');
  ...
  for (let i = 0; i < WARMUP_ITER; i++) {
    exports.jade_stream_chacha_chacha20_amd64_avx(streamPtr, STREAM_LENGTH, noncePtr, keyPtr);
  }
